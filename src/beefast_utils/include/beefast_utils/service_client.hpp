...
#ifndef BEEFAST_UTILS__SERVICE_CLIENT_HPP_
#define BEEFAST_UTILS__SERVICE_CLIENT_HPP_
...
/**
 * @class beefast_utils::ServiceClient
...
#endif // BEEFAST_UTILS__SERVICE_CLIENT_HPP_
